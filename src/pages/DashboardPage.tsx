...
const StatCard: React.FC<StatCardProps> = ({ label, value, subtext, trend, trendValue, icon: Icon }) => {
  const trendColors = {
...
const QuickAction: React.FC<QuickActionProps> = ({ icon: Icon, title, subtitle, accent = false }) => {
  return (
    <button className="w-full p-3 md:p-4 border theme-border text-left hover:bg-black/5 dark:hover:bg-white/5 hover:border-axon-accent/50 transition-all group">
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
        {/* Activity Feed */}
        <div className="lg:col-span-2 theme-surface border theme-border">
          <div className="p-4 md:p-6 border-b theme-border flex items-center justify-between">
            ...
            <button className="px-4 py-2 border theme-border text-xs uppercase hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
              View All
            </button>
          </div>
        ...
        {/* Quick Actions */}
        <div className="theme-surface border theme-border">
      ...
      {/* Footer */}
      <footer className="mt-6 md:mt-8 pt-4 md:pt-6 border-t theme-border flex flex-col md:flex-row justify-between gap-4 theme-text-muted text-xs">
